-- 004_catalog_v2.sql — v2 카탈로그 스키마 (시즌 / 에피소드 / 콘텐츠 / 소스)
...
-- Supabase migration history가 없는 기존 수동 적용 DB에서도 재실행 가능해야 한다.
...
drop policy if exists "public read content_sources" on content_sources;
